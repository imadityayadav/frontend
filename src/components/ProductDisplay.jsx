  ...
  return (
    <div className="flex flex-col lg:flex-row my-0 mx-4 lg:mx-[130px]">
      <div className="flex flex-col gap-4">
        <div className="overflow-x-scroll flex gap-4 sm:overflow-visible">
          <img
        ...
        <div>
          <img
            className="w-full lg:w-[720px] h-[500px] object-cover"
            src={product.image}
            alt=""
          />
        </div>
      ...
      <div className="flex flex-col my-0 mx-0 lg:mx-[70px]">
        <h1 className="text-2xl lg:text-[40px] text-[#3d3d3d] font-extrabold">
          {product.name}
        </h1>
        ...
        <div className="text-sm lg:text-base">
          ...
          quod porro, doloribus repellendus accusantium ex dolore obcaecati
          nobis ad.
        </div>

        <div>
          <h1 className="mt-[55px] font-bold text-[#656565] text-lg lg:text-[20px]">
            Select Size
          </h1>
          <div className="flex my-6 mx-0 ml- gap-2">
            {["S", "M", "L", "XL", "XXL"].map((size) => (
              <div
                key={size}
                className="py-2 px-4 bg-[#fbfbfb] border-[1px] border-[#ebebeb] rounded-sm cursor-pointer hover:bg-[#1c1c1c] hover:text-white"
              >
                {size}
              </div>
            ))}
        ...
        <button
          ...
          className="py-4 px-6 w-full lg:w-[200px] text-[16px] font-bold text-white bg-[#ff4141] mb-[40px] cursor-pointer"
        >
          ADD TO CART
        </button>
        <p className="mt-2">
