...
const Items = (props) => {
  return (
    <div className="w-[320px] hover:scale-105 transition duration-150 hover:shadow-2xl max-[1280px]:w-[300px] max-[1280px]:text-[14px] max-[1024px]:w-[210px] max-[1024px]:text-[13px] max-[800px]:w-[160px] max-[800px]:text-[12px] max-[500px]:w-[180px]">
      <Link to={`/product/${props.id}`} onClick={() => window.scrollTo(0, 0)}>
        <img
          className="w-full h-auto max-[1280px]:w-full max-[1024px]:w-full max-[800px]:w-full max-[500px]:w-full"
          src={props.image}
          alt={props.name}
        />
      </Link>
