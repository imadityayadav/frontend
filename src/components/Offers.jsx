  ...
  return (
    <div className="offers w-full h-auto flex flex-col md:flex-row mt-12 mx-0 mb-36 bg-gradient-to-r from-[#5A585A] to-[#090947] p-5 md:p-20">
      <div className="offer-left flex flex-1 flex-col justify-center">
        <h1 className="text-[#171717] text-5xl md:text-[80px] font-bold">
          Exclusive
        </h1>
        <h1 className="text-[#171717] text-xl md:text-[22px] font-bold">
          Offers for you
        </h1>
        <p className="text-base">ONLY ON BEST SELLER PRODUCTS</p>
        <button className="w-[282px] h-[70px] rounded-full bg-[#ff4141] hover:bg-[#c22e2e] transition-all text-white text-xl mt-6 cursor-pointer">
          Check Now
        </button>
      </div>
