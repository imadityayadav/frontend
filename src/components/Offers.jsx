  ...
  return (
    <div className='offers w-full h-auto flex flex-col md:flex-row mt-12 mx-0 mb-36 bg-gradient-to-r from-[#5A585A] to-[#090947] p-5 md:p-20'>
      <div className='offer-left flex flex-1 flex-col justify-center'>
        <h1 className='text-[#fff] text-5xl md:text-[80px] font-bold'>Exclusive</h1>
        <h1 className='text-[#fff] text-xl md:text-[22px] font-bold'>Offers for you</h1>
        <p className='text-base text-[#fff]'>ONLY ON BEST SELLER PRODUCTS</p>
